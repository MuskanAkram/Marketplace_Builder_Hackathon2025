  ...
  return (
    <div className="bg-white w-full py-8 px-6 sm:px-10 md:px-16 lg:px-20 xl:px-32">
      <div className="flex flex-col sm:flex-row justify-between items-start space-y-8 sm:space-y-0 sm:space-x-8">
        ...
        <div className="flex flex-col w-full sm:w-1/4">
          <p className="text-sm sm:text-base text-[#9F9F9F] font-semibold">
            Links
          </p>
          <p className="text-sm sm:text-base text-black py-2 mt-2 hover:text-gray-600">
            Home
          </p>
          <p className="text-sm sm:text-base text-black py-2 mt-2 hover:text-gray-600">
            Shop
        ...
        <div className="flex flex-col w-full sm:w-1/4">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center mt-4">
            ...
            />
            <button className="mt-4 sm:mt-0 sm:ml-4 text-sm sm:text-base font-semibold text-black cursor-pointer hover:underline border-b-2 border-transparent">
              Subscribe
            </button>
          </div>
        </div>
