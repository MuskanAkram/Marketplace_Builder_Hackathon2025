          ...
          <div className="col-span-2 space-y-6">
            {currentPosts.map((post: any) => (
              <div key={post.id} className="mt-12">
                ...
                <div className="text-black underline mt-4 inline-block">
                  Read More
                </div>
              </div>
            ))}
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              <li className="flex items-center space-x-4">
                ...
                />
                <div>
                  <h2 className="text-gray-700 hover:text-[#B88E2F]">
        ...
        {Array.from({ length: totalPages }, (_, index) => (
          <div
            ...
            className={`w-[60px] h-[60px] flex items-center justify-center text-black font-bold text-xl cursor-pointer ${
              currentPage === index + 1
                ? "bg-[#B88E2F] text-white rounded-[10px]"
                : "bg-[#F9F1E7] rounded-[10px]"
            }`}
          >
            {index + 1}
          </div>
